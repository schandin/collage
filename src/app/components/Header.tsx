...
import { Scissors, UserCircle, ShieldCheck, Briefcase, Menu, X } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Sheet, SheetContent, SheetTrigger, SheetClose } from '@/components/ui/sheet';
import React, { useState } from 'react';

const navLinks = [
  { href: '/', label: 'Inicio', icon: <Scissors className="w-4 h-4" /> },
  { href: '/artistas', label: 'Nuestros Artistas', icon: <UserCircle className="w-4 h-4" /> },
  { href: '/suscripciones', label: 'Suscripciones', icon: <Briefcase className="w-4 h-4" /> },
  { href: '/panel-artista', label: 'Panel Artista', icon: <Scissors className="w-4 h-4" /> },
